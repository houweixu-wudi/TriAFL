...
def generate_cifar100(dir_path, num_clients, num_classes, niid, balance, partition):
    ...
    trainset = torchvision.datasets.CIFAR100(
        root="Cifar100/rawdata", train=True, download=False, transform=transform)
    testset = torchvision.datasets.CIFAR100(
        root="Cifar100/rawdata", train=False, download=False, transform=transform)
