...
class Client(object):
    ...
    def load_train_data(self, batch_size=None):
        ...
        train_data = Dataset(data=read_client_data(self.dataset, self.id, is_train=True), dataset_name=self.dataset)  #使用fedspeed的数据增强
    ...
    def test_metrics(self):
        testloaderfull = self.testloaderfull
